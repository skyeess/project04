    ...
    if ($i_like.hasClass("fa-heart")) {
        $.ajax({
            ...
            success: function (response) {
                ...
                $a_like.find("span.like-num").text(num2str(response["count_heart"]));
            },
        });
    } else {
        $.ajax({
    ...
    if ($i_like.hasClass("fa-star")) {
        $.ajax({
            ...
            success: function (response) {
                ...
                $a_like.find("span.like-num").text(num2str(response["count_star"]));
            },
        });
    } else {
        $.ajax({
...
function toggle_thumbs(post_id, type) {
    ...
    if ($i_like.hasClass("fa-thumbs-up")) {
        $.ajax({
            ...
            success: function (response) {
                console.log("unthumbs");
                $i_like.addClass("fa-thumbs-o-up").removeClass("fa-thumbs-up");
                $a_like.find("span.like-num").text(num2str(response["count_thumbs"]));
            },
        });
    } else {
        $.ajax({
